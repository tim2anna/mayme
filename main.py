...
engine = create_engine(settings.DATABASE_URL, **settings.DATABASE_SETTINGS)
import models
...
class DemoErrorPanel(wx.Panel):
    ...
    def __init__(self, parent, codePanel, demoError, log):
        ...
        from views.ListCtrl import TestListCtrl
...
class wxPythonDemo(wx.Frame):
    ...
    def OnHelpAbout(self, event):
        from views.About import MyAboutBox
...
<h2>MayMe</h2>
<p> MayMe is a order costing software.
"""
