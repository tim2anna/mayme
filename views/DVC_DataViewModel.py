    ...
    def GetValue(self, item, col):
        ...
        if isinstance(node, Genre):
            ...
            mapper = { 0 : node.name,
                       ...
                       2 : "123",
                       3 : "123",
                       4 : node.date,  # TODO: There should be some way to indicate a null value...
                       5 : node.like,
                       }
            return mapper[col]
...
class SubTablePanel(wx.Panel):
    ...
    def OnNewView(self, evt):
        ...
        SubTablePanel(f, self.log, model=self.model)
...
def runTest(frame, nb, log):
    ...
    win = SubTablePanel(nb, log, data=data)
    return win
